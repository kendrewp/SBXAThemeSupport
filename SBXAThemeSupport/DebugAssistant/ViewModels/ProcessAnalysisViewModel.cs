...
namespace SBXAThemeSupport.DebugAssistant.ViewModels
{
    ...
    public class ProcessAnalysisViewModel : ViewModel
    {
        ...
        /// </summary>
        /// <param name="source">Where the expression is being called from.
        /// </param>
        /// <param name="hookType">
        ...
        private void AddProcessToCollection(string processFileName, string pName, SBString defn, ProcessLoadState processLoadState = null)
        {
            if (DebugWindowManager.DebugConsoleWindow == null)
            {
                return;
        ...
        private void AnalyseProcessCommandExecuted(object parameter)
        {
            ...
            this.LoadProcessFromExpression(
                ...
                DebugViewModel.Instance.ProcessAnalysisViewModel.ProcessName);
        }
        ...
        /// </summary>
        /// <param name="processFileName">The name of the file that contains the process.
        /// </param>
        /// <param name="pName">
        /// The name of the definition.
        /// </param>
