                    ...
                    delegate
                        {
                            ...
                            JobManager.RunInDispatcherThread(DebugWindowManager.DebugConsoleWindow.Dispatcher, DispatcherPriority.Normal,
                                () => RevisionDefinitionViewModel.AddItemToDefinition(collection, new RevisionDefinitionItem() { Action = "1", FileName = fileName, Item = this.CodeTable, Parameters = RevisionDefinitionViewModel.Data }));
